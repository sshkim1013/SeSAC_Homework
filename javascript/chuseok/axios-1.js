...
async function getAllProductArray() {
  const response = await axios.get(`${BASE_URL}/products`);
  const data = response["data"];
...
async function getSearchPosts(param) {
  const response = await axios.get(`${BASE_URL}/posts/search?q=${param}`);
  const data = response["data"];
  console.log(data);
}
getSearchPosts("phone");
...
async function getSearchPostsArray(param) {
  const response = await axios.get(`${BASE_URL}/posts/search?q=${param}`);
  const data = response["data"];
  const posts = data["posts"];
  console.log(posts);
}
getSearchPostsArray("phone");
...
async function getPostsByUserId(id) {
  const config = { url: `${BASE_URL}/posts/user/${id}`, method: "GET" };
